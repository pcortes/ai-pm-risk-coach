...
import { CooBrief } from "./CooBrief";
import { getCooBrief } from "@/lib/coo-advisor";
        ...
        <div className="relative flex flex-col">
          ...
          <div className="mb-4">
            <CooBrief
              ...
              pid={session.capabilities.stageMessage ? session.pid : null}
              draftMeta={draftMeta}
            />
          </div>
          ...
          {showQuickReply && (
            <QuickReply
              ...
              canSendKeystroke={session.capabilities.sendKeystroke}
              suggestedReply={cooBrief.suggestedReply}
              draftMeta={draftMeta}
              onActed={(action) => {
          ...
          {cleanupState === "confirm" ? (
            ...
            <QuickActions
              path={session.workingDirectory}
              pid={session.capabilities.focusTerminal ? session.pid : null}
              targetScreen={targetScreen}
              status={displayStatus}
              prUrl={session.prUrl}
              canCreatePr={session.capabilities.createPr}
